...
<?php
    ...
    try {
      $dsn = 'mysql:host=' . $config['Hospital']['getrami'] . ';dbname=' . $config['Hospital']['getrami'];
      
      $conexion = new PDO($dsn, $config['Hospital']['getrami'], $config['Hospital']['K0nkl@b3'], $config['db']['options']);
