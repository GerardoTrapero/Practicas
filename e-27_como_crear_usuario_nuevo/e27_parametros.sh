...
# Se puede usar este script de la siguiente manera, proporcionando los tres parámetros requeridos al ejecutarlo:

# bash

# ./crear_usuario.sh usuario1 "Nombre Completo" contraseña123
